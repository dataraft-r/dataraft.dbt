#' @export
#' @importFrom dataraft.core dr_backend_lineage
dr_backend_lineage.dr_dbt_result <- function(x, ...) dr_dbt_lineage(x, ...)

#' @export
#' @importFrom dataraft.core dr_backend_lineage
dr_backend_lineage.dr_dbt_project <- function(x, ...) dr_dbt_lineage(x, ...)

#' @export
#' @importFrom dataraft.core dr_backend_lineage
dr_backend_lineage.character <- function(x, ...) dr_dbt_lineage(x, ...)

#' @export
#' @importFrom dataraft.core dr_backend_lineage
dr_backend_lineage.list <- function(x, ...) dr_dbt_lineage(x, ...)

#' @export
#' @importFrom dataraft.core dr_replace_backend_sources
dr_replace_backend_sources.dr_dbt_project <- function(x, replacements, ...) {
